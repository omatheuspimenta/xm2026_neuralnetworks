...
A grande inspiração para as redes neurais foi um experimento realizado em 1959 por Hubel & Wiesel: Receptive fields of single neurones in the cat's striate cortex
...
Um desafio de classificação que existia era o ImageNet, um banco de dados enorme com inúmeras classes. Entre 1989 e 1998. Yann Lecun desenvolveu o LeNet que basicamente é a base clássica das CNNs. Até 2012, o erro era bem grande dentro dessa competição. Contudo, em 2012, foi a primeira vez que uma CNN participou da competição e venceu por larga margem, a partir disso, todos os anos subsequentes foram vencidos por CNNs.   
